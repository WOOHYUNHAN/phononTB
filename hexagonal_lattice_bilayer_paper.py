...
lat_hex_bilayer = [[1,   -np.sqrt(3), 0.0], [1,   np.sqrt(3), 0.0], [0.0,0.0,15.0]]
...
mass_hex_bilayer = [1.0, 1.0, 1.0, 1.0]
...
q_path_hex_bilayer = [[-1.0/3, 2.0/3, 0.0], [0, 0,0], [0.5, 0.0,0], [1.0/3, 1.0/3,0], [0.0, 0,0]]
...
###############################################################################
DM_hex_bilayer = DynamicalMatrix('hexagonal_bilayer', FC_hex_bilayer, alpha0)
...
CTI_hex = ComputeTopologicalInvariants('hexagonal_bilayer',band_range, q_grid)
