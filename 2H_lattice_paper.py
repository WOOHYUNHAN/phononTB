...
lat = [[1.,   -np.sqrt(3),0.0], [1.,   np.sqrt(3),0.0], [0.0, 0.0, 10.0]]
...
###############################################################################
band_range = [int(i) for i in range(16,17)] ; print '# of bands = ' + str(len(band_range)) + ' Detail bands = ' + str(band_range)
