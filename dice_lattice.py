...
q_grid = ['slice',[2, 2, 1], 0.0]  #### [q_slice mode, [nx, ny, nz], fixed_qpoints]
...
#DM_dice.get_3Dplot_data(14)
DM_dice.make_anime_file_for_vsim([0.0, 0.0, 0.0])


###############################################################################
band_range = [int(i) for i in range(9,14)] ; print '# of bands = ' + str(len(band_range)) + ' Detail bands = ' + str(band_range)
